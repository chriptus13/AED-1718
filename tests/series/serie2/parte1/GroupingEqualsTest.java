...
import static series.serie2.parte1.Iterables.groupingEquals;
import static series.serie2.parte1.IterablesTest.*;

/**
 * Created by cvaz on 25/04/16.
 */
public class GroupingEqualsTest {
    ...
    public void groupingEquals_empty_iterable() {
        Iterable<String> empty = Collections.EMPTY_LIST;
        Iterable<Pair<String, Integer>> it = groupingEquals(empty);
        assertIterableEmpty(it);
    }
